...
import pandas as pd
import numpy as np
from chapter01 import pd_readcsv
from chapter04 import minimum_capital_for_sub_strategy
from chapter04_handcrafting import correlationEstimate, portfolioWeights, handcraftPortfolio
...
if __name__ == '__main__':
    ...
    all_returns = pd_readcsv('Data/example_instrument_returns.csv')
    ...
    instrument_config = pd.read_csv('Data/instrument_config.csv', index_col='instrument')
