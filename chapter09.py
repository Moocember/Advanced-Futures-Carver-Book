...
from chapter01 import calculate_stats
from chapter03 import standardDeviation
...
from chapter05 import calculate_perc_returns_for_dict_with_costs
from chapter07 import calculate_forecast_for_ewmac
from chapter08 import apply_buffering_to_position_dict
...
if __name__ == "__main__":
    ...
    perc_return = perc_return_agg
    from Backtester import fullBacktest
    print(fullBacktest(perc_return.dropna()))
    matplotlib.pyplot.plot((1+perc_return).cumprod())
